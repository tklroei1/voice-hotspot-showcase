...
Full evaluation scripts live with the private source; MELD is used to sanity-check the text layer. Figures reflect this project's held-out evaluation, not an external benchmark.
